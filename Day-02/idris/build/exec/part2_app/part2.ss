...
(define csegen-40 (cons (lambda (arg-8474) (lambda (arg-8477) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AnyBool arg-8474 arg-8477))) 0))
...
(define Main-removals (lambda (arg-1) (if (null? arg-1) (cons '() '()) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (cons e-3 (PreludeC-45TypesC-45List-mapAppend '() (lambda (u--ys) (cons e-2 u--ys)) (Main-removals e-3))))))))
...
(define Main-dampened (lambda (arg-1 arg-2) (PreludeC-45Types-u--foldMap_Foldable_List csegen-40 arg-1 (Main-removals arg-2))))
(define Main-dampened_safe (lambda (ext-0) (Main-dampened (lambda (eta-0) (Main-safe eta-0)) ext-0)))
...
(define PreludeC-45Types-elemBy (lambda (arg-2 arg-3 arg-4 ext-0) (let ((e-6 (vector-ref arg-2 5))) (((((e-6 'erased) 'erased) csegen-40) (arg-3 arg-4)) ext-0))))
