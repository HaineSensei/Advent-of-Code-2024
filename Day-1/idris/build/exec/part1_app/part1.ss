...
(define csegen-2 (vector (lambda (arg-5904) (lambda (arg-5907) (+ arg-5904 arg-5907))) (lambda (arg-5914) (lambda (arg-5917) (* arg-5914 arg-5917))) (lambda (arg-5924) arg-5924)))
(define csegen-4 (vector csegen-2 (lambda (arg-6023) (- 0 arg-6023)) (lambda (arg-6029) (lambda (arg-6032) (- arg-6029 arg-6032)))))
...
(define csegen-21 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Integer u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_Integer u--d u--x)))))
(define csegen-22 (cons csegen-21 csegen-21))
...
(define Main-parseLine (lambda (arg-0) (let ((u--words (DataC-45String-words arg-0))) (if (null? u--words) '() (let ((e-1 (car u--words))) (let ((e-2 (cdr u--words))) (if (null? e-2) '() (let ((e-4 (car e-2))) (let ((e-5 (cdr e-2))) (if (null? e-5) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (DataC-45String-parseInteger csegen-2 csegen-4 e-1) (lambda (u--numX) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (DataC-45String-parseInteger csegen-2 csegen-4 e-4) (lambda (u--numY) (box (cons u--numX u--numY)))))) '()))))))))))
